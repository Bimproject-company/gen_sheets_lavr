...
// Type: SheetGen.Selector.CropboxSelection
...
{
  public class CropboxSelection : ISelection
  {
    public IEnumerable<Element> GetElements(
      ExternalCommandData commandData,
      BuiltInCategory builtInCategory)
    {
      return (IEnumerable<Element>) commandData.Application.ActiveUIDocument.Selection.PickElementsByRectangle();
    }
    ...
    public IEnumerable<Element> GetFilteredElements(
      ...
      BuiltInCategory builtInCategory)
    {
      return (IEnumerable<Element>) commandData.Application.ActiveUIDocument.Selection.PickElementsByRectangle(selectionFilter);
    }
  }
}
